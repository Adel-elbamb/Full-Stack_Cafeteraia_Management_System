...
if(isset($_POST['order_id']) && isset($_POST['change_amount'])){
    ...
    // header("Location: http://localhost/Cafeteria_php/Cafeteria_php/pages/myorder.php");
    // exit();
    header("Location: " . $_SERVER['REQUEST_SCHEME'] . "://" . $_SERVER['HTTP_HOST'] . "/Cafeteria_php/Cafeteria_php/pages/myorder.php");
    exit();
